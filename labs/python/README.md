...
3. Near the end of the process a prompt will ask where the source is inside the container. This value is related to the directories in the Dockerfile. Press Enter to accept the default
...
10. Stop the “Debug” mode by pressing the stop button and remove the breakpoint by clicking on the breakpoint again.
